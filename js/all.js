...
function() {
  for (var e, t = function() {}, n = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeline", "timelineEnd", "timeStamp", "trace", "warn"], r = n.length, i = window.console = window.console || {}; r--;) e = n[r], i[e] || (i[e] = t)
}(),
function(e) {
  var t = function() {
    e("#menu-toggle").toggleClass("active"), e("html").toggleClass("menu-is-open"), e(".menu").toggleClass("open")
  };
  e("#menu-toggle, .menu-close").on("click", function() {
      t()
    }), e(".js-menu-item").on("click", function() {
    ...
    function() {
      ...
      e(window).scroll(function() {
        e(this).scrollTop() > r ? n.addClass("scrolled") : n.removeClass("scrolled")
      })
    }()
}(jQuery);